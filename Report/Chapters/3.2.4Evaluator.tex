The final big component is the \textit{Evaluator} as seen in \ref{fig:firstSprint}. It is a CherryPy service that can be executed on any machine running python and
